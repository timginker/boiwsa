...
boiwsa is a package for seasonal adjustment of weekly data. It is implemented using a locally-weighted least squares procedure (Cleveland et al., 2014). We consider the following decomposition model:
